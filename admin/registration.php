...
<body>
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <form id="scheduleForm">
                    ...
                    <input class="form-control my-3 rounded-3" type="date" id="inspectionDate" name="inspectiondate" required>
                    <input class="form-control my-3 rounded-3" type="time" id="inspectionTime" name="inspectiontime" required>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                        <button type="submit" name="submit" class="btn btn-success rounded-3">Add schedule</button>
                    </div>
                    </form>
                </div>
            </div>
    ...
    $('#scheduleForm').on('submit', function(e) {
      ...
      e.preventDefault();
        ...
        // Add schedule
        $.ajax({
          url: 'add_registrationschedule.php',
          type: 'POST',
          data: formData,
          enctype: 'multipart/form-data',
          contentType: false,
