        ...
        <div class="row">
            ...
            <div class="col-md-3 pt-3 container">
                ...
                <form id="schedule-form">
                    <div class="mb-3">
                        <p id="businessId">Business Id</p>
                    </div>
                    <div class="mb-3">
                        <p id="storeName">Store Name</p>
                    </div>
                    <div class="mb-3">
                        <p id="storeLocation">Store Location</p>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <p id="assignedDay">Day of week.</p>
                        <div id="dayWeekErr" class="form-text error"></div>
                    </div>
                    <div class="inspectioncon" id="inspection"> 
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                    <label for="inspectorList">Select inspectors:</label>
                    <!-- A place to display the checklist -->
                    <ul id="monthList"></ul>
                    <div id="assignedInsErr" class="form-text error"></div>
                    </div>
                    </div>
